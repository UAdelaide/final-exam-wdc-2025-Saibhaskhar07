...
app.get('/api/walkers/summary', async (req, res) => {
  try {
    const [WalkerSummary] = await db.execute('SELECT Users.username, COUNT(WalkRatings.rating_id, AVG(WalkRatings.rating),COUNT(CASE WHEN WalkRequest.status = "Completed" AND WalkApplication.status = "Accepted"');
